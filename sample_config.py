...
class Config(object):
    ...
    ZELZAL_A = int(os.environ.get("ZELZAL_A") or --1002116081436)
    ...
    fv_av = os.environ.get("fv_av", "𝟭𝟮𝟯𝟰𝟱𝟲𝟳𝟴𝟵𝟬")
    ...
    TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "fv_av")
    # for custom thumb image set this with your required thumb telegraoh link
    THUMB_IMAGE = os.environ.get(
        "THUMB_IMAGE", "https://telegra.ph/file/4df54bf139c38e1cfc7a7.jpg"
    )
