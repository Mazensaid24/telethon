...
Zed_Vip = (5951674553, 5449190469, 5449190469, 5951674553, 5449190469, 5951674553, 5449190469, 5449190469, 5951674553, 5449190469, 5951674553, 5449190469, 5449190469, 5951674553, 5951674553, 5951674553, 5951674553, 5449190469, 5951674553, 232499688, 5951674553, 5449190469, 5449190469)
zchannel = {"@fv_av", "@C1_F5", "@Ve_G4", "@C1_F5", "@fv_av", "@RR_U_RR", "@Ve_G4", "@C1_F5", "@C1_F5", "@fv_av", "@fv_av", "@fv_av", "@fv_av", "@C1_F5", "@C1_F5", "@fv_av", "@fv_av", "@C1_F5", "@C1_F5"}
    ...
    try:
        if BOTLOG:
            Config.ZEDUBLOGO = await zedub.tgbot.send_file(
                ...
                buttons=[(Button.url("𝗡𝗶𝗡𝗝𝗔", "https://t.me/fv_av"),)],
            )
    except Exception as e:
        LOGS.error(e)
        return None
