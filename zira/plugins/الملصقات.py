# تحديث واضافات نينجا
# ZThon UsetBot T.me/fv_av
# Devolper mazen T.me/Ve_G4
import asyncio
import base64
import contextlib
import io
...
async def get_pack_info(event):
    ...
    OUTPUT = (
        f"ᯓ 𝗡𝗶𝗡𝗝𝗔 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - معلومـات الملصـق 🎟\n"
        f"⋆┄─┄─┄─┄┄─┄─┄─┄─┄┄⋆\n"
...
async def zelzal_gif(event):
    ...
    chat = "@Stickers" #Code by T.me/Ve_G4
    ...
    async with borg.conversation(chat) as conv: #Code by T.me/Ve_G4
        try:
            ...
            await conv.get_response()
            await conv.send_file(reply) #Code by T.me/Ve_G4
            await conv.get_response()
