...
zel_dev = (5951674553, 5449190469, 5951674553, 5449190469)
...
async def ge(user, event):
    ...
    try:
        ...
        return None
    return user_obj
########################  ninga Userbot ~ By: mazen (@Ve_G4)  ########################
@zedub.zed_cmd(pattern="رابط الحذف")
async def _(zed):
    await edit_or_reply (zed, "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 𝗡𝗶𝗡𝗝𝗔 - 𝘿𝙀𝙇𝙀𝙏𝙀](t.me/5449190469) 🗑♻️𓆪\n**𓍹━─━─━─━─𝗡𝗶𝗡𝗝𝗔─━─━─━─━𓍻**\n\n **✵│رابـط الحـذف ↬** https://telegram.org/deactivate \n\n\n **✵│بـوت الحـذف¹  ↬** @LC6BOT\n**✵│بـوت الحـذف²  ↬** @DTeLebot")
########################  ninga Userbot ~ By: mazen (@Ve_G4)  ########################
@zedub.zed_cmd(pattern="بوت الحذف")
async def _(zed):
    await edit_or_reply (zed, "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 𝗡𝗶𝗡𝗝𝗔 - 𝘿𝙀𝙇𝙀𝙏𝙀](t.me/fv_av) 🗑♻️𓆪\n**𓍹━─━─━─━─𝗡𝗶𝗡𝗝𝗔─━─━─━─━𓍻**\n\n **✵│رابـط الحـذف ↬** https://telegram.org/deactivate \n\n\n **✵│بـوت الحـذف¹  ↬** @LC6BOT\n**✵│بـوت الحـذف²  ↬** @DTeLebot")
########################  mazen Userbot ~ By: mazen (@Ve_G4)  ########################
...
########################  ninga Userbot ~ By: mazen (@Ve_G4)  ########################
ZelzalTHS_cmd = (
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝗡𝗶𝗡𝗝𝗔 𝗖𝗼𝗻𝗳𝗶𝗴 𝗩𝗮𝗿𝘀 - اوامـر التحشيش](t.me/fv_av) 𓆪\n\n"
