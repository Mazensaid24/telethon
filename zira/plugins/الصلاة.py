...
Credit: T.me/ZThon
@Ve_G4 - كتـابـة الملـف :  مازن الهيبــه"""
...
async def get_adzan(adzan):
    ...
    if ninga == "صنعاء" or ninga == "اليمن":
	    ...
	    "
	    await edit_or_reply(adzan, zedthonresult, "html")
    elif ninga == "بغداد" or ninga == "العراق":
	    ...
	    "
	    await edit_or_reply(adzan, zedthonresult, "html")
    elif ninga == "دمشق" or ninga == "سوريا":
	    ...
	    "
	    await edit_or_reply(adzan, zedthonresult, "html")
    elif ninga == "مسقط" or ninga == "سلطنه عمان":
	    ...
	    "
	    await edit_or_reply(adzan, zedthonresult, "html")
    elif ninga == "بيروت" or ninga == "لبنان":
	    ...
	    "
	    await edit_or_reply(adzan, zedthonresult, "html")
    elif ninga == "الرباط" or ninga == "المغرب":
	    ...
	    "
	    await edit_or_reply(adzan, zedthonresult, "html")
    elif ninga == "الخرطوم" or ninga == "السودان":
	    ...
	    "
	    await edit_or_reply(adzan, zedthonresult, "html")
    elif ninga == "بنغازي" or ninga == "ليبيا":
	    ...
	    "
	    await edit_or_reply(adzan, zedthonresult, "html")
    elif ninga == "ازمير" or ninga == "اسطنبول" or ninga == "انقره" or ZELZAL == "تركيا":
