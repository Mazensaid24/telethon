...
حقـوق للتـاريخ : @fv_av
@Ve_G4 - كتـابـة الملـف :  مازن الهيبــه"""
#مازن_الهيبـه يولـد هههههههههههههههههههههههههه
import asyncio
import math
import os
...
ZelzalVP_cmd = (
    "𓆩 [𝗡𝗶𝗡𝗝𝗔 𝗖𝗼𝗻𝗳𝗶𝗴 𝗩𝗮𝗿𝘀 - اوامـر الفـارات](t.me/fv_av) 𓆪\n\n"
    ...
    "\n𓆩 [𝗡𝗶𝗡𝗝𝗔 𝗩𝗮𝗿𝘀 - قنـاة الفـارات](t.me/fv_av) 𓆪"
)
...
async def variable(event):
    ...
    # All Rights Reserved for "Zed-Thon" "مازن الهيبـه"
...
async def custom_zed(event):
    ...
    if (input_str == "كليشة الحماية" or input_str == "كليشة الحمايه" or input_str == "كليشه الحماية" or input_str == "كليشه الحمايه"):
        ...
        if variable is None:
            ...
            await zed.edit("**⎉╎الفـار {} موجـود ☑️**\n**⎉╎قيمـة الفـار : ↶**\n `{}` \n\n**⎉╎قنـاة السـورس : @fv_av**".format(input_str, variable))
        ...
        if variable is None:
            await zed.edit("**⎉╎فـار ايموجي/رمز الايدي غيـر موجـود ❌**\n**⎉╎لـ اضـافته بالـرد ع الكليشـة من هنا ( @fv_av ) استخـدم الامـر : ↶**\n `.اضف كليشة الايدي` \n\n**⎉╎قنـاة السـورس : @fv_av**")
        else:
            await zed.edit("**⎉╎الفـار {} موجـود ☑️**\n**⎉╎قيمـة الفـار : ↶**\n `{}` \n\n**⎉╎قنـاة السـورس : @fv_av**".format(input_str, variable))
...
async def variable(event):
    ...
    # All Rights Reserved for "ni-nga" "مازن الهيبـه"
    ...
    if malatha.reply_to_msg_id:
        ...
        if input_str in ["الحماية", "الحمايه"]:
            ...
            try:
                ...
                await zed.edit("**⎉╎تم تغييـر صـورة {} .. بنجـاح ☑️**\n**⎉╎المتغيـر : ↶**\n `{}` \n\n**⎉╎قنـاة السـورس : @fv_av**".format(input_str, vinfo))
