...
""" 
Logo & Style for ninga™ t.me/fv_av
Write file by mazen t.me/Ve_G4
...
async def lg1(userevent):
    ...
    if arabic_text: # code by t.me/Ve_G4
...
async def lg1(userevent):
    ...
    if not arabic_text: # code by t.me/Ve_G4
