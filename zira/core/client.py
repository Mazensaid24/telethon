            ...
            async def wrapper(check):  # sourcery no-metrics
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        link = "[𝗠 𝗮 𝗭 𝗲 𝗡](https://t.me/ve_g4)"
                        text = (
                            "**✘ تقـريـر اشعـار نينجا 𝗡𝗶𝗡𝗝𝗔 ✘**\n\n"
            ...
            async def wrapper(check):
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**✘ تقـريـر اشعـار نينحا 𝗡𝗶𝗡𝗝𝗔 ✘**\n\n "
                        link = "[𐇮 𝗠 𝗮 𝗭 𝗲 𝗡 𐇮](https://t.me/ve_g4)"
